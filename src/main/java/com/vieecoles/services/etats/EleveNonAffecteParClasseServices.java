...
public class EleveNonAffecteParClasseServices {
    ...
    public List<eleveNonAffecteParClasseDto>  eleveNonAffecteParClasse(Long idEcole){
        int LongTableau;
