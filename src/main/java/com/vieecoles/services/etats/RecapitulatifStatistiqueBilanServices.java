...
@ApplicationScoped
public class RecapitulatifStatistiqueBilanServices {
    @Inject
    EntityManager em;
    @Inject
    ...
    public List<PyramideEffectDto> getPyramide(Long idEcole ,Long anneeId ){
      ...
      List<PyramideEffectDto> resultatsListElevesDto = new ArrayList<>() ;
        ...
        for (int i=0; i< sizeClass;i++) {
            ...
            naffnbreF = getAffecteClasse(anneeId,niveauDtoList.get(i).getId() ,"FEMININ","AFFECTE") ;
            naffnbreG = getAffecteClasse(anneeId,niveauDtoList.get(i).getId() ,"MASCULIN","AFFECTE") ;
    ...
    Long getEffectReaffecteClasse(Long idAnneId ,Long idBranche ,String sexe  ,Boolean reaffecte ) {
        //  Inscriptions.statusEleve aff = Inscriptions.statusEleve.valueOf(aff1);
        try {
            TypedQuery<Long> q = (TypedQuery<Long>) em.createQuery( "SELECT  count(o.id) from ClasseEleve o  where o.classe.branche.id =: idBranche and o.inscription.eleve.sexe =:sexe and o.inscription.annee.id=:idAnn " +
    ...
    Long getEffeTransferesClasse(Long idAnneId ,Long idBranche ,String sexe  ,Boolean transfert ) {
        //  Inscriptions.statusEleve aff = Inscriptions.statusEleve.valueOf(aff1);
        try {
            TypedQuery<Long> q = (TypedQuery<Long>) em.createQuery( "SELECT  count(o.id) from ClasseEleve o  where o.classe.branche.id =: idBranche and o.inscription.eleve.sexe =:sexe and o.inscription.annee.id=:idAnn " +
    ...
    Long getEffeIvoiriensClasse(Long idAnneId ,Long idBranche ,String sexe ,Boolean ivoirien ) {
        //  Inscriptions.statusEleve aff = Inscriptions.statusEleve.valueOf(aff1);
        try {
            TypedQuery<Long> q = (TypedQuery<Long>) em.createQuery( "SELECT  count(o.id) from ClasseEleve o  where o.classe.branche.id =: idBranche and o.inscription.eleve.sexe =:sexe and o.inscription.annee.id=:idAnn " +
    ...
    Long getEffeAfricanClasse(Long idAnneId ,Long idBranche ,String sexe ,Boolean africain ) {
        //  Inscriptions.statusEleve aff = Inscriptions.statusEleve.valueOf(aff1);
        try {
            TypedQuery<Long> q = (TypedQuery<Long>) em.createQuery( "SELECT  count(o.id) from ClasseEleve o  where o.classe.branche.id =: idBranche and o.inscription.eleve.sexe =:sexe and o.inscription.annee.id=:idAnn " +
    ...
    Long getEffeNonAfricanClasse(Long idAnneId ,Long idBranche ,String sexe ,Boolean nonafricain ) {
        //  Inscriptions.statusEleve aff = Inscriptions.statusEleve.valueOf(aff1);
        try {
            TypedQuery<Long> q = (TypedQuery<Long>) em.createQuery( "SELECT  count(o.id) from ClasseEleve o  where o.classe.branche.id =: idBranche and o.inscription.eleve.sexe =:sexe and o.inscription.annee.id=:idAnn " +
    ...
    Long getEffeInterneClasse(Long idAnneId ,Long idBranche ,String sexe ,Boolean interne ) {
        //  Inscriptions.statusEleve aff = Inscriptions.statusEleve.valueOf(aff1);
        try {
            TypedQuery<Long> q = (TypedQuery<Long>) em.createQuery( "SELECT  count(o.id) from ClasseEleve o  where o.classe.branche.id =: idBranche and o.inscription.eleve.sexe =:sexe and o.inscription.annee.id=:idAnn " +
    ...
    Long getEffeDemiPensionClasse(Long idAnneId ,Long idBranche ,String sexe ,Boolean demipension ) {
        //  Inscriptions.statusEleve aff = Inscriptions.statusEleve.valueOf(aff1);
        try {
            TypedQuery<Long> q = (TypedQuery<Long>) em.createQuery( "SELECT  count(o.id) from ClasseEleve o  where o.classe.branche.id =: idBranche and o.inscription.eleve.sexe =:sexe and o.inscription.annee.id=:idAnn " +
    ...
    Long getEffeExterneClasse(Long idAnneId ,Long idBranche ,String sexe ,Boolean externe ) {
        //  Inscriptions.statusEleve aff = Inscriptions.statusEleve.valueOf(aff1);
        try {
            TypedQuery<Long> q = (TypedQuery<Long>) em.createQuery( "SELECT  count(o.id) from ClasseEleve o  where o.classe.branche.id =: idBranche and o.inscription.eleve.sexe =:sexe and o.inscription.annee.id=:idAnn " +
