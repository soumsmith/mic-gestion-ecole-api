...
public class MatriceMoyenneServices {
    ...
    public List<MatriceMoyenneDto>  DspspDto(Long idEcole, String libellePeriode , String libelleAnnee ,String Classe){
        ...
        TypedQuery<NiveauDto> q = em.createQuery( "SELECT new com.vieecoles.dto.NiveauDto(b.matricule) from Bulletin b  where b.ecoleId =:idEcole and b.libelleClasse=: Classe  and b.libellePeriode=:periode and b.anneeLibelle=:libelleAnnee order by b.nom asc, b.prenoms asc ,b.ordreNiveau"
               , NiveauDto.class);
