...
@ApplicationScoped
public class MajorAnnuelsParNiveauPoiServices {
    @Inject
    EntityManager em;
    ...
    public Double getMajorDto(Long idEcole , String niveau,String libelleAnnee , String libelleTrimestre){
        ...
        try {
            TypedQuery<Double> q= (TypedQuery<Double>) em.createQuery("select MAX(o.moyAn) from Bulletin o where  o.ecoleId =:idEcole and  o.niveau=:niveau  and o.libellePeriode=:periode and o.anneeLibelle=:annee");
            classeNiveauDtoList = q.setParameter("idEcole",idEcole)
                    .setParameter("niveau",niveau)
                    .setParameter("annee", libelleAnnee)
                    .setParameter("periode", libelleTrimestre)
