...
@ApplicationScoped
public class resultatsAnnuelsNonAffectePoiIntervalServices {
    @Inject
    EntityManager em;

    public List<ResultatsElevesNonAffecteDto> CalculResultatsEleveAffecte(Long idEcole ,String libelleAnnee , String libelleTrimestre,int order1 ,int order2 ){

        List<ClasseNiveauDto> classeNiveauDtoList = new ArrayList<>() ;
        TypedQuery<ClasseNiveauDto> q = em.createQuery( "SELECT new com.vieecoles.dto.ClasseNiveauDto(b.libelleClasse ,b.niveau) from Bulletin b  where b.ecoleId =:idEcole and b.affecte=:affecte and b.libellePeriode=:periode and b.anneeLibelle=:annee and b.ordreNiveau>:order1 and b.ordreNiveau<:order2 " +
  ...
  public  Integer getEffectifParClasse(Long idEcole ,String classe, String niveau ,String annee , String periode){
      ...
      try {
          effectifClasse = (Integer) em.createQuery("select o.effectif from Bulletin o where  o.ecoleId=:idEcole and o.affecte=:affecte and  o.anneeLibelle=:annee and o.libellePeriode=: periode group by o.libelleClasse , o.niveau,o.effectif having o.libelleClasse=:classe and o.niveau=:niveau ")
  ...
  public  Long geteffeG(Long idEcole ,String classe, String niveau ,String annee , String periode){
      ...
      Long  effeG ;
      try {
          effeG= (Long) em.createQuery("select count(o.id) from Bulletin o where  o.sexe=:sexe and o.ecoleId=:idEcole and o.affecte=:affecte and  o.anneeLibelle=:annee and o.libellePeriode=: periode group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
  ...
  public  Long getclassF(Long idEcole ,String classe, String niveau ,String annee , String periode){
      Long classF;
      try {
          classF = (Long) em.createQuery("select count(o.id) from Bulletin o where  o.sexe=:sexe and o.ecoleId=:idEcole and o.affecte=:affecte and o.isClassed=:isClass and  o.anneeLibelle=:annee and o.libellePeriode=: periode group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
                  .setParameter("sexe","FEMININ")
                  .setParameter("idEcole",idEcole)
                  .setParameter("affecte","NON_AFFECTE")
    ...
    public Long getclassG(Long idEcole ,String classe, String niveau ,String annee , String periode){
        Long classG;
        try {
            classG = (Long) em.createQuery("select count(o.id) from Bulletin o where  o.sexe=:sexe and o.ecoleId=:idEcole and o.affecte=:affecte and o.isClassed =:isClass and  o.anneeLibelle=:annee and o.libellePeriode=: periode group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
                    .setParameter("sexe","MASCULIN")
                    .setParameter("idEcole",idEcole)
                    .setParameter("affecte","NON_AFFECTE")
                    .setParameter("isClass","O")
    ...
    public  Long getNonClasseF(Long idEcole ,String classe, String niveau ,String annee , String periode){
        try {
            Long nonclassF = (Long) em.createQuery("select count(o.id) from Bulletin o where  o.sexe=:sexe and o.ecoleId=:idEcole and o.affecte=:affecte and o.isClassed =:isClass and o.anneeLibelle=:annee and o.libellePeriode=: periode group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
                    .setParameter("sexe","FEMININ")
                    .setParameter("idEcole",idEcole)
                    .setParameter("affecte","NON_AFFECTE")
    ...
    public  Long getNonClasseG(Long idEcole ,String classe, String niveau ,String annee , String periode){
        try {
            Long    nonclassG = (Long) em.createQuery("select count(o.id) from Bulletin o where  o.sexe=:sexe and o.ecoleId=:idEcole and o.affecte=:affecte and o.isClassed =:isClass and o.anneeLibelle=:annee and o.libellePeriode=: periode group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
                    .setParameter("sexe","MASCULIN")
                    .setParameter("idEcole",idEcole)
                    .setParameter("affecte","NON_AFFECTE")
                    .setParameter("isClass","N")
