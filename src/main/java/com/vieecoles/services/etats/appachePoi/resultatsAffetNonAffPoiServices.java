...
@ApplicationScoped
public class resultatsAffetNonAffPoiServices {
    @Inject
    EntityManager em;

    public List<ResultatsElevesAffecteDto> CalculResultatsEleveAffecte(Long idEcole ,String libelleAnnee , String libelleTrimestre,int order ){
