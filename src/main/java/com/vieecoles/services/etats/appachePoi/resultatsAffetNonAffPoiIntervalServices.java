...
@ApplicationScoped
public class resultatsAffetNonAffPoiIntervalServices {
    @Inject
    EntityManager em;

    public List<ResultatsElevesAffecteDto> CalculResultatsEleveAffecte(Long idEcole ,String libelleAnnee , String libelleTrimestre,int order1 ,int order2 ){

        List<ClasseNiveauDto> classeNiveauDtoList = new ArrayList<>() ;
        TypedQuery<ClasseNiveauDto> q = em.createQuery( "SELECT new com.vieecoles.dto.ClasseNiveauDto(b.libelleClasse ,b.niveau) from Bulletin b  where b.ecoleId =:idEcole and b.libellePeriode=:periode and b.anneeLibelle=:annee and b.ordreNiveau>:order1 and b.ordreNiveau<:order2 " +
        ...
        classeNiveauDtoList = q.setParameter("idEcole", idEcole)
                          //.setParameter("affecte", "AFFECTE")
                            .setParameter("periode", libelleTrimestre)
                              ...
                              .setParameter("order1", order1)
                              .setParameter("order2", order2)
                           . getResultList() ;
  ...
  public  Long getclassF(Long idEcole ,String classe, String niveau ,String annee , String periode){
      Long classF;
      try {
          classF = (Long) em.createQuery("select count(o.id) from Bulletin o where  o.sexe=:sexe and o.ecoleId=:idEcole  and o.isClassed=:isClass and o.libellePeriode=:periode and o.anneeLibelle =:annee group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
                  .setParameter("sexe","FEMININ")
                  .setParameter("idEcole",idEcole)
    ...
    public Long getclassG(Long idEcole ,String classe, String niveau ,String annee , String periode){
        Long classG;
        try {
            classG = (Long) em.createQuery("select count(o.id) from Bulletin o where  o.sexe=:sexe and o.ecoleId=:idEcole  and o.isClassed=:isClass and o.libellePeriode=:periode and o.anneeLibelle =:annee group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
                    .setParameter("sexe","MASCULIN")
                    .setParameter("idEcole",idEcole)
                    .setParameter("isClass","O")
                    .setParameter("classe",classe)
    ...
    public  Long getNonClasseF(Long idEcole ,String classe, String niveau ,String annee , String periode){
        try {
            Long nonclassF = (Long) em.createQuery("select count(o.id) from Bulletin o where  o.sexe=:sexe and o.ecoleId=:idEcole  and o.isClassed=:isClass and o.libellePeriode=:periode and o.anneeLibelle =:annee group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
                    .setParameter("sexe","FEMININ")
                    .setParameter("idEcole",idEcole)
    ...
    public  Long getNonClasseG(Long idEcole ,String classe, String niveau ,String annee , String periode){
        try {
            Long    nonclassG = (Long) em.createQuery("select count(o.id) from Bulletin o where  o.sexe=:sexe and o.ecoleId=:idEcole  and o.isClassed=:isClass and o.libellePeriode=:periode and o.anneeLibelle =:annee group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
                    .setParameter("sexe","MASCULIN")
                    .setParameter("idEcole",idEcole)
                    .setParameter("isClass","N")
                    .setParameter("classe",classe)
    ...
    public  Long getnbreMoySup10F(Long idEcole ,String classe, String niveau ,String annee , String periode){
        try {
            Long   nbreMoySup10F = (Long) em.createQuery("select count(o.id) from Bulletin o where  o.sexe=:sexe and o.ecoleId=:idEcole and o.isClassed=:isClass  and o.moyGeneral>=:moy and o.libellePeriode=:periode and o.anneeLibelle =:annee group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
                    .setParameter("sexe","FEMININ")
                    .setParameter("idEcole",idEcole)
    ...
    public Long getnbreMoySup10G(Long idEcole ,String classe, String niveau ,String annee , String periode){
        try {
            Long    nbreMoySup10G = (Long) em.createQuery("select count(o.id) from Bulletin o where  o.sexe=:sexe and o.ecoleId=:idEcole and o.isClassed=:isClass  and o.moyGeneral>=:moy and o.libellePeriode=:periode and o.anneeLibelle =:annee  group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
                    .setParameter("sexe","MASCULIN")
                    .setParameter("idEcole",idEcole)
                    .setParameter("moy",10.0)
                    .setParameter("isClass","O")
    ...
    public Long getnbreMoyInf999G(Long idEcole ,String classe, String niveau ,String annee , String periode){
        try {
            Long nbreMoyInf999G = (Long) em.createQuery("select count(o.id) from Bulletin o where  o.sexe=:sexe and  o.isClassed=:isClass and   o.ecoleId=:idEcole  and o.moyGeneral>=:moy and o.moyGeneral <=:moy2 and o.libellePeriode=:periode and o.anneeLibelle =:annee  group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
                    .setParameter("sexe","MASCULIN")
                    .setParameter("idEcole",idEcole)
                    .setParameter("moy",8.5)
                    .setParameter("moy2",9.99)
    ...
    public Long getnbreMoyInf85G(Long idEcole ,String classe, String niveau  ,String annee , String periode){
        try {
            Long   nbreMoyInf85G = (Long) em.createQuery("select count(o.id) from Bulletin o where  o.sexe=:sexe and o.isClassed=:isClass and o.ecoleId=:idEcole  and o.moyGeneral<:moy and o.libellePeriode=:periode and o.anneeLibelle =:annee  group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
                    .setParameter("sexe","MASCULIN")
                    .setParameter("idEcole",idEcole)
                    .setParameter("moy",8.5)
                    .setParameter("isClass","O")
    ...
    public Long getnbreMoyInf85F(Long idEcole ,String classe, String niveau ,String annee , String periode){
        try {
            Long  nbreMoyInf85F = (Long) em.createQuery("select count(o.id) from Bulletin o where  o.sexe=:sexe and o.isClassed=:isClass and o.ecoleId=:idEcole  and o.moyGeneral<:moy and o.libellePeriode=:periode and o.anneeLibelle =:annee  group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
                    .setParameter("sexe","FEMININ")
                    .setParameter("idEcole",idEcole)
                    .setParameter("moy",8.5)
                    .setParameter("isClass","O")
    ...
    public  Double getmoyClasse(Long idEcole ,String classe, String niveau ,String annee , String periode){
        try {
            Double   moyClasseF = (Double) em.createQuery("select AVG(o.moyGeneral) from Bulletin o where   o.ecoleId=:idEcole  and o.isClassed=:isClass and o.libellePeriode=:periode and o.anneeLibelle =:annee group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
                    .setParameter("idEcole",idEcole)
                    .setParameter("isClass","O")
                    .setParameter("classe",classe)
                    .setParameter("niveau",niveau)
    ...
    public  Double getmoyClasseF(Long idEcole ,String classe, String niveau ,String annee , String periode){
        try {
            Double   moyClasseF = (Double) em.createQuery("select AVG(o.moyGeneral) from Bulletin o where  o.sexe=:sexe and o.ecoleId=:idEcole  and o.isClassed=:isClass and o.libellePeriode=:periode and o.anneeLibelle =:annee group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
                    .setParameter("sexe","FEMININ")
                    .setParameter("idEcole",idEcole)
                    .setParameter("isClass","O")
                    .setParameter("classe",classe)
    ...
    public  Double  getmoyClasseG(Long idEcole ,String classe, String niveau ,String annee , String periode){
        try {
            Double  moyClasseG = (Double) em.createQuery("select AVG(o.moyGeneral) from Bulletin o where  o.sexe=:sexe and o.ecoleId=:idEcole  and o.isClassed=:isClass and o.libellePeriode=:periode and o.anneeLibelle =:annee group by o.libelleClasse , o.niveau having o.libelleClasse=:classe and o.niveau=:niveau")
                    .setParameter("sexe","MASCULIN")
                    .setParameter("idEcole",idEcole)
                    .setParameter("isClass","O")
                    .setParameter("classe",classe)
    ...
    public  Double  getmoyClasseNiv(Long idEcole ,String classe, String niveau ,String annee , String periode){
        try {
            Double  moyClasseG = (Double) em.createQuery("select AVG(o.moyGeneral) from Bulletin o where   o.ecoleId=:idEcole  and o.isClassed=:isClass and o.libellePeriode=:periode and o.anneeLibelle =:annee group by  o.niveau having  o.niveau=:niveau")
                    .setParameter("idEcole",idEcole)
                    .setParameter("isClass","O")
                    .setParameter("niveau",niveau)
                    .setParameter("annee",annee)
