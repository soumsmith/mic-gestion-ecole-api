...
@ApplicationScoped
public class resultatsNonAffecteServicesAnnuels {
    @Inject
    EntityManager em;

    public List<ResultatsElevesNonAffecteDto> CalculResultatsEleveAffecte(Long idEcole ,String libelleAnnee , String libelleTrimestre){
