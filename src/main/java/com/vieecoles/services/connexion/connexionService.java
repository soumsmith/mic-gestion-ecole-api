...
public class connexionService implements PanacheRepositoryBase<utilisateur_has_personnel, Long> {
	...
	public String affecterProfilUtilisateur(AffecterProfilUtilisateurDto myUtilisaDto) {
		...
		for (int i = 0; i < myUtilisaDto.getListProfil().size(); i++) {
			...
			myutilisateurPerson = veriCompteUtilisateurEcole(myUtilisaDto.getPersonnel_personnelid(),
					myUtilisaDto.getEcole_ecoleid(), myUtilisaDto.getListProfil().get(i).getProfilid());
			...
			if (myutilisateurPerson != null) {
				...
				if (myutilisateur2 != null) {
					...
					utilisatPersonDto.setUtilisateur_has_person_date_debut(LocalDate.now());
					utilisatPersonDto
							.setUtilisateur_has_person_date_fin(myUtilisaDto.getUtilisateur_has_person_date_fin());
					affeterUtilisateurProfil(utilisatPersonDto);
					messageRetour = "Compte créé avec succès!";
					if (!messageRetour.equals("Compte créé avec succès!")) {
						profil myProfil = new profil();
...
//        System.out.println("myPersoDto "+myPersoDto);
	...
	public long getIdSouscripteur(Long idPersonnel) {
		...
		try {
			idSouscripteur = (Long) em.createQuery(
					"select o.sous_attent_personn.sous_attent_personnid from personnel  o  where  o.personnelid =:idPersonnel ")
					.setParameter("idPersonnel", idPersonnel).getSingleResult();
		} catch (Exception e) {
			e.printStackTrace();
			idSouscripteur = 0L;
		}
	...
	public String getEmailSouscripteur(Long idPersonnel) {
		...
		try {
			emailSouscripteur = (String) em.createQuery(
					"select o.sous_attent_personn.sous_attent_personn_email from personnel  o  where  o.personnelid =:idPersonnel ")
					.setParameter("idPersonnel", idPersonnel).getSingleResult();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public long getIdUtilisateur(String login) {
		Long IdUtilisateur = null;
		try {
			IdUtilisateur = (Long) em
					.createQuery("select o.utilisateurid from utilisateur  o  where  o.utilisateu_login =:login ")
					.setParameter("login", login).getSingleResult();
			return IdUtilisateur;
		} catch (Exception e) {
			if (e instanceof NoResultException) {
				logger.info("Aucun utilisateur trouvé avec l'email fourni.");
			} else {
				e.printStackTrace();
			}
			return 0L;
	...
	public Long getIDpersonnel(Long idUtilisateur, Long idEcole) {
		...
		try {
			IdPersonnel = (Long) em.createQuery(
					"select distinct  o.personnel_personnelid from utilisateur_has_personnel  o  where  o.utilisateur.utilisateurid =:idUtilisateur and o.ecole_ecoleid=:idEcole ")
					.setParameter("idUtilisateur", idUtilisateur).setParameter("idEcole", idEcole).getSingleResult();
			return IdPersonnel;
		} catch (Exception e) {
			if (e instanceof NoResultException) {
				logger.info("Aucun utilisateur trouvé avec l'email fourni.");
	...
	public personnelConnexionDto getInfoPersonn(Long idPersonnel) {
		personnelConnexionDto myPersoDto = new personnelConnexionDto();
		try {
			myPersoDto = (personnelConnexionDto) em.createQuery(
					"select  new com.vieecoles.dto.personnelConnexionDto(o.personnelid,o.personnelnom,o.personnelprenom ,pl.profil_libelle) from personnel o, profil pl ,utilisateur_has_personnel  ut where o.personnelid=ut.personnel_personnelid and pl.profilid = ut.profil.profilid and  o.personnelid=:idPersonnel",
					personnelConnexionDto.class).setParameter("idPersonnel", idPersonnel).getSingleResult();
			return myPersoDto;
		} catch (Exception e) {
			if (e instanceof NoResultException) {
				logger.info("Aucun utilisateur trouvé avec l'email fourni.");
	...
	public personnelConnexionDto getInfoPersonnel(Long idPersonnel, Long profilId) {
		...
		try {
			myPersoDto = (personnelConnexionDto) em.createQuery(
					"select  new com.vieecoles.dto.personnelConnexionDto(o.personnelid,o.personnelnom,o.personnelprenom ,pl.profil_libelle) from personnel o, profil pl ,utilisateur_has_personnel  ut where o.personnelid=ut.personnel_personnelid and pl.profilid = ut.profil.profilid and  o.personnelid=:idPersonnel and ut.profil.profilid=:profilId",
					personnelConnexionDto.class).setParameter("idPersonnel", idPersonnel)
					.setParameter("profilId", profilId).getSingleResult();
			return myPersoDto;
		} catch (Exception e) {
			if (e instanceof NoResultException) {
				logger.info("Aucun utilisateur trouvé avec l'email fourni.");
...
//        	System.out.println("email :  "+email);
			myPersoDto = (parametreConnexion) em.createQuery(
					"select  new com.vieecoles.dto.parametreConnexion(o.utilisateu_login ,o.utilisateur_mot_de_passe) from utilisateur o where o.utilisateu_email=:email ",
					parametreConnexion.class).setParameter("email", email).getSingleResult();
			return myPersoDto;
		} catch (Exception e) {
			if (e instanceof NoResultException) {
				logger.info("Aucun utilisateur trouvé avec l'email fourni.");
	...
	public CandidatConnexionDto getInfoPersonnCandidat(Long idPersonnel) {
		CandidatConnexionDto myPersoDto = new CandidatConnexionDto();
		try {
			myPersoDto = (CandidatConnexionDto) em.createQuery(
					"select  new com.vieecoles.dto.CandidatConnexionDto(o.sous_attent_personnid,o.sous_attent_personn_nom,o.sous_attent_personn_prenom,o.sous_attent_personn_email,'1',f.fonctionlibelle) from sous_attent_personn  o join o.fonction f where  o.sous_attent_personnid =:idPersonnel",
					CandidatConnexionDto.class).setParameter("idPersonnel", idPersonnel).getSingleResult();
			return myPersoDto;
		} catch (Exception e) {
			if (e instanceof NoResultException) {
				logger.info("Aucun utilisateur trouvé avec l'email fourni.");
	...
	public String CreerCompteUtilisateur(String emailUtilisateur, String motDepasse,
			utilisateur_has_personnelDto myUtilisaDto) {
...
//         System.out.print("UserBy Email "+myutilisateur2.toString());
		...
		if (myutilisateur2 != null) {
			...
			for (int i = 0; i < myUtilisaDto.getListProfil().size(); i++) {
				myutilisateurPerson = veriCompteUtilisateurEcole(myUtilisaDto.getPersonnel_personnelid(),
						myUtilisaDto.getEcole_ecoleid(), myUtilisaDto.getListProfil().get(i));
				...
				if (myutilisateurPerson != null) {
					...
					utilisatPersonDto
							.setUtilisateur_has_person_date_debut(myUtilisaDto.getUtilisateur_has_person_date_debut());
					utilisatPersonDto
							.setUtilisateur_has_person_date_fin(myUtilisaDto.getUtilisateur_has_person_date_fin());
					affeterUtilisateurProfil(utilisatPersonDto);
					messageRetour = "Compte créé avec succès!";
...
//                                            System.out.print("valDiff "+val);
				...
				if (val < 0) {
					...
					try {
						...
						myLogin = (utilisateur) em.createQuery(
								"select o from utilisateur o where o.utilisateu_login =:login and o.utilisateur_mot_de_passe=:motPasse")
								.setParameter("login", login.trim()).setParameter("motPasse", motdePasse.trim())
								.getSingleResult();
						if (!(myLogin == null)) {
							profilUtilsateur = myUtiliPers.getProfil().getProfil_libelle();
							messageRetour = profilUtilsateur;
	...
	public utilisateur_has_personnel getUtilisateurPersonn(String email, Long Profilid, Long Ecoleid) {
		...
		try {
			return (utilisateur_has_personnel) em.createQuery(
					"select o from utilisateur_has_personnel  o  where  o.ecole_ecoleid =:codeEcole and o.utilisateur.utilisateurid =:utilisateurId and o.profil.profilid=:profilId")
					.setParameter("utilisateurId", myutilisateur2.getUtilisateurid()).setParameter("codeEcole", Ecoleid)
					.setParameter("profilId", Profilid).getSingleResult();
		} catch (Exception e) {
			if (e instanceof NoResultException) {
				logger.info("Aucun utilisateur trouvé avec l'email fourni.");
	...
	public utilisateur_has_personnel getUtilisateurPersonnAdmin(String email, Long Profilid) {
		...
		try {
			return (utilisateur_has_personnel) em.createQuery(
					"select o from utilisateur_has_personnel  o  where   o.utilisateur.utilisateurid =:utilisateurId and o.profil.profilid=:profilId")
					.setParameter("utilisateurId", myutilisateur2.getUtilisateurid()).setParameter("profilId", Profilid)
					.getSingleResult();
		} catch (Exception e) {
			if (e instanceof NoResultException) {
				logger.info("Aucun utilisateur trouvé avec l'email fourni.");
	 ...
	 * 
	 * TypedQuery<InscriptionAvaliderDto> q = em.createQuery(
	 * "SELECT new com.vieecoles.projection.compteUtilisateurSelect() from utilisateur_has_personnel o join o.profil p  where e.ecoleid=:idecole "
	 * +
	 * " and  o.inscriptions_status=: Status  and o.inscriptions_processus=: processus"
	 * , InscriptionAvaliderDto.class); List<InscriptionAvaliderDto>
	 * listInscriptionAvaliderDto = q.setParameter("idecole" ,idecole)
	 * .setParameter("Status" ,Status).setParameter("processus",processus).
	 * getResultList(); return listInscriptionAvaliderDto; }
	 */
	...
	public String deSactiverProfilEcole(Long ecoleId, Long profilId, int active) {
		utilisateur_has_personnel myUtilis = new utilisateur_has_personnel();
		String messageRetour = null;
		int q = em.createQuery(
				"update utilisateur_has_personnel e set  e.utilisateur_has_person_active=:activier  where e.ecole_ecoleid=:ecoleId and e.profil.profilid=:profilId ")

				.setParameter("activier", active).setParameter("ecoleId", ecoleId).setParameter("profilId", profilId)
				.executeUpdate();
	...
	@Transactional
	public String modifierInfosCompte(Long utilisateurPersonnId, Long ecoleId, Long personnelId, Long profilId,
...
//@Transactional
	public utilisateur checkPassword(String login, String motdePasse) {
		try {
			return (utilisateur) em.createQuery(
					"select o from utilisateur o where o.utilisateu_login =:login and o.utilisateur_mot_de_passe=:motPasse")
					.setParameter("login", login.trim()).setParameter("motPasse", motdePasse.trim()).getSingleResult();
		} catch (Exception e) {
			if (e instanceof NoResultException) {
				logger.info("Aucun utilisateur trouvé avec l'email fourni.");
			} else {
	...
	public utilisateur verifiEmailUtilisateur(String emailUtilisateur) {
		try {
			return (utilisateur) em.createQuery("select o from utilisateur o where o.utilisateu_email =:email")
					.setParameter("email", emailUtilisateur).getSingleResult();
		} catch (Exception e) {
			if (e instanceof NoResultException) {
				logger.info("Aucun utilisateur trouvé avec l'email fourni.");
			} else {
	...
	public String pseudo(String login) {
		try {
			return (String) em
					.createQuery("select o.utilisateu_login from utilisateur o where o.utilisateu_login =:login")
					.setParameter("login", login).getSingleResult();
		} catch (Exception e) {
			if (e instanceof NoResultException) {
				logger.info("Aucun utilisateur trouvé avec l'email fourni.");
	...
	public utilisateur_has_personnel veriCompteUtilisateurEcole(Long personnelId, Long codeEcole, Long profilId) {
		...
		try {
			return (utilisateur_has_personnel) em.createQuery(
					"select o from utilisateur_has_personnel  o  where  o.ecole_ecoleid =:codeEcole and o.personnel_personnelid =:personnelId and o.profil.profilid=:profilId")
					.setParameter("personnelId", personnelId).setParameter("codeEcole", codeEcole)
					.setParameter("profilId", profilId).getSingleResult();
		} catch (Exception e) {
			if (e instanceof NoResultException) {
				logger.info("Aucun utilisateur trouvé avec l'email fourni.");
