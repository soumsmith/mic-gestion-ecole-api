...
public class EnseignantParDisciplineServices {
   ...
   @Transactional
    public EnseignantDisciplineDto EnseignantParDiscipline(Long idEcole, String libellePeriode , String libelleAnnee){
     ...
     Long nbreFARPLMusi2; Long nbreGARPLMusi2; Long nbreFARPLMusi1; Long nbreGARPLMusi1;
     Long nbreFINFO1;Long nbreGINFO1; Long nbreFINFO2;Long nbreGINFO2;
           ...
           System.out.println("mascul "+mascul);
            System.out.println("feminin "+feminin);

            System.out.println("nbreFMATH1 "+nbreFMATH1);
             System.out.println("nbreGMATH1 "+nbreGMATH1);
            ...
            nbreFARPLMusi1= getNbreProfArtplMus1(libellePeriode,libelleAnnee ,idEcole, feminin);
            nbreGARPLMusi1= getNbreProfArtplMus1(libellePeriode,libelleAnnee ,idEcole, mascul);
            m.setNbreGARPLMusi1(nbreGARPLMusi1);
            m.setNbreFARPLMusi1(nbreFARPLMusi1);

           nbreFARPLMusi2= getNbreProfArtplMus2(libellePeriode,libelleAnnee ,idEcole, feminin);
           nbreGARPLMusi2= getNbreProfArtplMus2(libellePeriode,libelleAnnee ,idEcole, mascul);
           m.setNbreGARPLMusi2(nbreGARPLMusi2);
           m.setNbreFARPLMusi2(nbreFARPLMusi2);

         nbreFINFO1 = getNbreProf1(13L,libellePeriode,libelleAnnee ,idEcole, feminin) ;
         nbreGINFO1 = getNbreProf1(13L,libellePeriode,libelleAnnee ,idEcole, mascul) ;

           m.setNbreGINFO1(nbreFINFO1);
           m.setNbreFINFO1(nbreGINFO1);

           nbreFINFO2 = getNbreProf2(13L,libellePeriode,libelleAnnee ,idEcole, feminin) ;
           nbreGINFO2 = getNbreProf2(13L,libellePeriode,libelleAnnee ,idEcole, mascul) ;

               m.setNbreGINFO2(nbreFINFO2);
               m.setNbreFINFO2(nbreGINFO2);
  ...
  public  Long getNbreProfArtplMus1(String periode ,String libelleAnnee ,Long idEcole ,String sexe){
    try {
      Long   moyClasseF = (Long) em.createQuery("select count(distinct d.nom_prenom_professeur)  from DetailBulletin  d join d.bulletin b  where  d.matiereId in (19,20)  and b.anneeLibelle=:libelleAnnee " +
    ...
    public  Long getNbreProfArtplMus2(String periode ,String libelleAnnee ,Long idEcole ,String sexe){
        try {
            Long   moyClasseF = (Long) em.createQuery("select count(distinct d.nom_prenom_professeur)  from DetailBulletin  d join d.bulletin b  where  d.matiereId in(19,20) and b.anneeLibelle=:libelleAnnee " +
                    " and b.libellePeriode=:periode and b.ecoleId=:idEcole and b.ordreNiveau>=5 and d.sexeProfesseur=:sexe")
                .setParameter("periode",periode)
