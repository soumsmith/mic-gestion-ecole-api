...
@ApplicationScoped
public class WordTempResultaAffEtNonAffAnnuelProcessor {
    @Inject
    resultatsAffetNonAffPoiServices resultatsServices ;
    @Inject
    resultatsRecapServices resultatsRecapServices ;
  @Inject
  com.vieecoles.services.etats.appachePoi.Annuels.resultatsAnnuelsAffetNonAffPoiIntervalServices resultatsAffetNonAffPoiIntervalServices ;
  @Inject
  EntityManager em;

      public   void getResultatAffEtNonAffProcessor(XWPFDocument document ,
        ...
        try {
          ...
          totalSeconde= resultatsAffetNonAffPoiIntervalServices.CalculResultatsEleveAffecte(idEcole,libelleAnnee,libelleTrimetre,4,7);
          totalPremiere= resultatsAffetNonAffPoiIntervalServices.CalculResultatsEleveAffecte(idEcole,libelleAnnee,libelleTrimetre,6,10);
          totalTerminale= resultatsAffetNonAffPoiIntervalServices.CalculResultatsEleveAffecte(idEcole,libelleAnnee,libelleTrimetre,9,15);
        ...
        // Sixième
        try{
          String tableTitle = "CODE_RECAP_RESUL_AFF_ET_NON_AFFECT_CLASSE_ANNUEL";
