...
@ApplicationScoped
public class WordTempRecapNonResultatAnnuelsProcessor {

    @Inject
    resultatsRecapNonAffAnnuelleServices resultatsRecapServices ;

    public   void getRecapResultatANonffProcessor(XWPFDocument document ,
                                          Long idEcole ,String libelleAnnee , String libelleTrimetre) {
        XWPFTable table = obtenirUnTableau(document,"RecapNonAffAnnuel");
