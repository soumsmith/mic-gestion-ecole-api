...
@ApplicationScoped
public class WordTempRecapAffNonAffResultatAnnuelsProcessor {

    @Inject
    resultatsRecapAffEtNonAffServicesAnnuels resultatsRecapServices ;

    public   void getRecapResultatAffProcessor(XWPFDocument document ,
                                          Long idEcole ,String libelleAnnee , String libelleTrimetre) {
        XWPFTable table = obtenirUnTableau(document,"RecapAffNonAffAnnuel");
        ...
        for (RecapResultatsElevesAffeEtNonAffDto classe : detailsBull) {
            long nombMoySup10 =
