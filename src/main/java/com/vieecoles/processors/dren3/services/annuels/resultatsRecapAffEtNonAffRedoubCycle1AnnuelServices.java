...
@ApplicationScoped
public class resultatsRecapAffEtNonAffRedoubCycle1AnnuelServices {
    @Inject
    EntityManager em;
  ...
  public  Long getclassF(Long idEcole , String niveau ,String libelleAnnee , String libelleTrimestre){
    ...
    public Long getnbreMoyInf999F(Long idEcole , String niveau ,String libelleAnnee , String libelleTrimestre){
        try {
            Long nbreMoyInf999F = (Long) em.createQuery("select count(o.id) from Bulletin o where o.isClassed=:isClass and o.sexe=:sexe and o.ecoleId=:idEcole  and o.moyAn>=:moy and o.moyAn <=:moy2 and o.libellePeriode=:periode and o.anneeLibelle=:annee and o.redoublant=:red group by  o.niveau having  o.niveau=:niveau ")
                    .setParameter("sexe","FEMININ")
                    .setParameter("idEcole",idEcole)
    ...
    public Long getnbreMoyInf999G(Long idEcole , String niveau ,String libelleAnnee , String libelleTrimestre){
        try {
            Long nbreMoyInf999G = (Long) em.createQuery("select count(o.id) from Bulletin o where o.isClassed=:isClass and o.sexe=:sexe and o.ecoleId=:idEcole  and o.moyAn>=:moy and o.moyAn <=:moy2 and o.libellePeriode=:periode and o.anneeLibelle=:annee and o.redoublant=:red group by  o.niveau having  o.niveau=:niveau  ")
                    .setParameter("sexe","MASCULIN")
                    .setParameter("idEcole",idEcole)
                    .setParameter("moy",8.5)
                    .setParameter("moy2",9.99)
