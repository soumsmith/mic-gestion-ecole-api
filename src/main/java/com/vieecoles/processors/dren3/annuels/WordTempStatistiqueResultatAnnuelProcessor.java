...
import com.vieecoles.processors.dren3.services.annuels.resultatsRecapAffEtNonAffCycle1AnnuelServices;
import com.vieecoles.processors.dren3.services.annuels.resultatsRecapAffEtNonAffCycle2AnnuelServices;
...
@ApplicationScoped
public class WordTempStatistiqueResultatAnnuelProcessor {
    @Inject
    resultatsRecapAffEtNonAffCycleServices resultatsServices ;
  @Inject
  resultatsRecapAffEtNonAffCycle1AnnuelServices resultatsServices1 ;
  @Inject
  resultatsRecapAffEtNonAffCycle2AnnuelServices resultatsServices2 ;
    @Inject
  ...
  EntityManager em;
      ...
      public   void getResultatAffProcessor(XWPFDocument document ,
        ...
        // Sixième
        XWPFTable table = obtenirUnTableau(document,"CODE_STATISTIQUE_RESULTAT_ANNUELS");
        try {
