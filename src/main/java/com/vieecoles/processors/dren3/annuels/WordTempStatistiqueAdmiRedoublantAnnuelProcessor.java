...
import com.vieecoles.processors.dren3.services.annuels.resultatsRecapAffEtNonAffRedoubCycle1AnnuelServices;
import com.vieecoles.processors.dren3.services.annuels.resultatsRecapAffEtNonAffRedoubCycle2AnnuelServices;
import com.vieecoles.processors.dren3.services.annuels.resultatsRecapAffEtNonAffRestrictCycle1AnnuelServices;
import com.vieecoles.processors.dren3.services.annuels.resultatsRecapAffEtNonAffRestrictCycle2AnnuelServices;
...
@ApplicationScoped
public class WordTempStatistiqueAdmiRedoublantAnnuelProcessor {
    @Inject
    resultatsRecapAffEtNonAffCycleServices resultatsServices ;
  @Inject
  resultatsRecapAffEtNonAffRestrictCycle1AnnuelServices resultatsServices1 ;
  @Inject
  resultatsRecapAffEtNonAffRestrictCycle2AnnuelServices resultatsServices2 ;
    @Inject
    resultatsRecapServices resultatsRecapServices ;
  @Inject
  resultatsRecapAffEtNonAffServicesAnnuels resultatsServices3 ;
  @Inject
  resultatsRecapAffEtNonAffRedoubCycle1AnnuelServices resultatsRedoubServices1 ;
  @Inject
  resultatsRecapAffEtNonAffRedoubCycle2AnnuelServices resultatsRedoubServices2 ;
  @Inject
  EntityManager em;
      ...
      public   void getStatistiqueAdminRedoublantProcessor(XWPFDocument document ,
        ...
        XWPFTable table = obtenirUnTableau(document,"CODE_ADMI_REDOUBLANT");
        try {
    ...
    private  void ajoutTableauDynamique(List<RecapResultatsElevesAffeEtNonAffDto> elevesPremierCycle, List<RecapResultatsElevesAffeEtNonAffDto> elevesSecondCycle,
      ...
      if(!elevesPremierCycle.isEmpty()){
        ...
        for (RecapResultatsElevesAffeEtNonAffDto eleve : elevesPremierCycle) {
          ...
          row1.getCell(0).setText(afficherValeurParNiveau(eleve.getNiveau()));
      ...
      for (RecapResultatsElevesAffeEtNonAffDto eleve : elevesSecondCycle) {
        ...
        XWPFTableRow row2 = table.createRow();
            ...
            row2.getCell(0).setText(afficherValeurParNiveau(eleve.getNiveau()));
