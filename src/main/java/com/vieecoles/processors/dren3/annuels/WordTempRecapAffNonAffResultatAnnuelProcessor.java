...
@ApplicationScoped
public class WordTempRecapAffNonAffResultatAnnuelProcessor {
    @Inject
    EntityManager em;
    @Inject
    resultatsRecapAffEtNonAffCycle1AnnuelServices resultatsRecapCycle1Services ;
    @Inject
    resultatsRecapAffEtNonAffCycle2AnnuelServices resultatsRecapCycle2Services ;

    public   void getRecapResultatAffProcessor(XWPFDocument document ,
                                          Long idEcole ,String libelleAnnee , String libelleTrimetre) {
        XWPFTable table = obtenirUnTableau(document,"SYNTESE_RESULTATS_ANNUELS");
