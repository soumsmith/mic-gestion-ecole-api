...
@ApplicationScoped
public class WordTempListNonAffectesAnnuelsProcessor {
    @Inject
    EntityManager em;
    @Inject
    EleveNonAffecteAnnuelsParClassePoiServices eleveAffecteParClassePoiServices ;
...
//Get classe
        ...
        for (int i = 0; i < paragraphs.size(); i++) {
            ...
            if (text.contains("Liste des élèves non affectés par classe(Annuel)")) {
        ...
        if (indexToInsert != -1) {
           // for (int z=0; z< classeList.size();z++) {
            ...
            headerRow.addNewTableCell().setText("MOY AN");
            ...
            for (eleveAffecteParClasseDtoAvecTousTrimestres eleve : elevAffectes) {  // Exemple de 3 lignes
                ...
                row.getCell(9).setText(String.valueOf(eleve.getMoyeGeneralTrim1()));
                row.getCell(10).setText(String.valueOf(eleve.getMoyeGeneralTrim2()));
                row.getCell(11).setText(String.valueOf(eleve.getMoyeGeneralTrim3()));
                row.getCell(12).setText(String.valueOf(eleve.getMoyenAnnuel()));
                row.getCell(13).setText(String.valueOf(eleve.getRangAn()));
                row.getCell(14).setText(eleve.getObservat());
                numerotation++;
            }
