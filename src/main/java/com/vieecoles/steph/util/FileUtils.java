...
public class FileUtils {
	...
	/**
	 * A wrapper for {@link File#renameTo(File)} which creates new File handles for
	 * both args.
	 *
	 * @param oldf the original filename
	 * @param newf the new filename
	...
	public static String generateNewFileName(String fileNameWithExtension) {
	...
	public static String getPathWithoutFileName(String uri) {
		System.out.println(uri);
		if(uri == null) {
			return "";
		}
		int sufffixIndex = uri.lastIndexOf("/");
		
		if (sufffixIndex >= 0) {
			System.out.println("Prefix uri : "+uri.substring(0, sufffixIndex));
			return uri.substring(0, sufffixIndex);
		} else {
			// No prefixe.
			return "";
		}
