...
public class ListeTransfertsParNiveauRessource {
    @Inject
    EntityManager em;
    @Inject
    IdentiteEtatService identiteEtatService ;
    @Inject
    TransfertsServices resultatsServices ;
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @Path("/list-transfert-par-niveau/{idEcole}")
    public List<TransfertsDto>  repartiParAnn(@PathParam("idEcole") Long idEcole) throws Exception, JRException {
        List<TransfertsDto>  detailsBull = new ArrayList<>() ;
        System.out.println("classeNiveauDtoList entree");
        detailsBull= resultatsServices.transferts(idEcole)  ;
        return detailsBull ;

    }

    @GET
    @Path("/imprimer-transfert-par-niveau/{idEcole}/{type}")
    ...
    public ResponseEntity<byte[]>  getDtoRapport(@PathParam("idEcole") Long idEcole ,@PathParam("type") String type) throws Exception, JRException {
        ...
        myInpuStream = this.getClass().getClassLoader().getResourceAsStream("etats/spider/Liste_transfert.jrxml");
    ...
    //to pdf ;
      ...
      headers.set(HttpHeaders.CONTENT_DISPOSITION,"inline;filename=Liste_transfert.pdf");
       ...
       // File exportReportFile = new File("profils" + ".docx");
        ...
        HttpHeaders headers= new HttpHeaders();
      headers.set(HttpHeaders.CONTENT_DISPOSITION,"inline;filename=Liste_transfert.docx");
