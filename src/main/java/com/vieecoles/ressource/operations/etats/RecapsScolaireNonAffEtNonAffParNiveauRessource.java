...
public class RecapsScolaireNonAffEtNonAffParNiveauRessource {
    @Inject
    EntityManager em;
    @Inject
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @Path("/list-recap-aff-et-non-affecte-par-classe-par-niveau/{idEcole}/{libelleAnnee}/{libelleTrimetre}")
    public List<RecapResultatsElevesAffeEtNonAffDto>  repartiParAnn(@PathParam("idEcole") Long idEcole
    ...
    @GET
    @Path("/imprimer-recap-aff-et-non-affecte-par-classe-par-niveau/{idEcole}/{type}/{libelleAnnee}/{libelleTrimetre}")
    ...
    public ResponseEntity<byte[]>  getDtoRapport(@PathParam("idEcole") Long idEcole ,@PathParam("type") String type ,@PathParam("libelleAnnee") String libelleAnnee,@PathParam("libelleTrimetre") String libelleTrimetre) throws Exception, JRException {
        ...
        myInpuStream = this.getClass().getClassLoader().getResourceAsStream("etats/spider/Recap_resultats_scolaire_aff_et_non_aff.jrxml");
