...
public class RecapsScolaireNonAffEtNonAffParNiveauRessource {
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @Path("/list-recap-aff-et-non-affecte-par-classe-par-niveau/{idEcole}")
    public List<RecapResultatsElevesAffeEtNonAffDto>  repartiParAnn(@PathParam("idEcole") Long idEcole) throws Exception, JRException {
    ...
    @GET
    @Path("/imprimer-recap-aff-et-non-affecte-par-classe-par-niveau/{idEcole}/{type}")
