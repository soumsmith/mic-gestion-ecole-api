...
@Path("/imprimer-rapport-cio-modele-deux")
//@Produces(MediaType.APPLICATION_JSON)
//@Consumes(MediaType.APPLICATION_JSON)

public class CIOModeleDeuxRessource {
    @Inject
    EntityManager em;
    @Inject
    ...
    @GET
    @Transactional
    @Path("/pouls-rapport-cio-modele-deux/{idEcole}/{libellePeriode}/{libelleAnnee}")
    ...
    public ResponseEntity<byte[]>  getDtoRapport(@PathParam("idEcole") Long idEcole ,@PathParam("libellePeriode") String libellePeriode ,
        ...
        myInpuStream = this.getClass().getClassLoader().getResourceAsStream("etats/spider/CIO_MODELE_2.jrxml");
...
// 👈 Tout en texte
       //exporter.setConfiguration(config);
        ...
        headers.set(HttpHeaders.CONTENT_DISPOSITION,"inline;filename=Rapport Pouls-Scolaire-cio-modele-deux.xls");
