...
public class DspsSpiderRessource {
    ...
    @GET
    @Transactional
    @Path("/pouls-rapport-dsps/{idEcole}/{libellePeriode}")
    @Produces(MediaType.APPLICATION_OCTET_STREAM)
    public ResponseEntity<byte[]>  getDtoRapport(@PathParam("idEcole") Long idEcole ,@PathParam("libellePeriode") String libellePeriode) throws Exception, JRException {
        ...
        dspsDto = dpspServices.DspspDto(idEcole,libellePeriode) ;
