...
@Entity
public class publicationCandidatSelectDto extends PanacheEntityBase {
    @Id
    ...
    private String nomCandidant;
    private String nomPrenomCandidant;

    public String getNomCandidant() {
        return nomCandidant;
    }

    public void setNomCandidant(String nomCandidant) {
        this.nomCandidant = nomCandidant;
    }

    public String getNomPrenomCandidant() {
        return nomPrenomCandidant;
    }

    public void setNomPrenomCandidant(String nomPrenomCandidant) {
        this.nomPrenomCandidant = nomPrenomCandidant;
    }
    ...
    public publicationCandidatSelectDto(Long id, String code,
                                        String libelle,
    ...
    public publicationCandidatSelectDto() {
    }
