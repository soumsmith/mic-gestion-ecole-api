...
public class LivretScolaireSpiderSelectDto {
   ...
   private int    trangFrAnnuel ;
    ...
    public LivretScolaireSpiderSelectDto() {
    }
    ...
    public String toString() {
        return "LivretScolaireSpiderSelectDto{" +
                "id_ecole=" + id_ecole +
                ", nom_ecole='" + nom_ecole + '\'' +
                ...
                ", moyennePremier=" + moyennePremier +
                ", rangPremier=" + rangPremier +
                ", moyenneDeuxieme=" + moyenneDeuxieme +
                ", rangDeuxieme=" + rangDeuxieme +
                ", moy_anMat=" + moy_anMat +
                ", rang_anMat=" + rang_anMat +
