...
public class utilisateur_has_personnel extends PanacheEntityBase {
    ...
    private com.vieecoles.entities.profil  profil;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "utilisateur_utilisateurid")
    private com.vieecoles.entities.utilisateur  utilisateur;
    ...
    public com.vieecoles.entities.profil getProfil() {
        return profil;
    }

    public void setProfil(com.vieecoles.entities.profil profil) {
        this.profil = profil;
    }

    public com.vieecoles.entities.utilisateur getUtilisateur() {
        return utilisateur;
    }

    public void setUtilisateur(com.vieecoles.entities.utilisateur utilisateur) {
