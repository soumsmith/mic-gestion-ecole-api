...
public class cycle extends PanacheEntityBase  {
    ...
    private List<com.vieecoles.entities.operations.ecole> ecole = new ArrayList<>();



    public List<com.vieecoles.entities.operations.ecole> getEcole() {
        return ecole;
    }

    public void setEcole(List<com.vieecoles.entities.operations.ecole> ecole) {
        this.ecole = ecole;
    }
