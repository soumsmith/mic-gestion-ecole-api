...
public class ecole extends PanacheEntityBase {
 @Id @GeneratedValue
    ...
    private com.vieecoles.entities.zone zone ;
    ...
    public com.vieecoles.entities.groupe_ecole getGroupe_ecole() {
        return groupe_ecole;
    }

    public void setGroupe_ecole(com.vieecoles.entities.groupe_ecole groupe_ecole) {
        this.groupe_ecole = groupe_ecole;
    }

    public com.vieecoles.entities.operations.quartier getQuartier() {
        return quartier;
    }

    public void setQuartier(com.vieecoles.entities.operations.quartier quartier) {
        this.quartier = quartier;
    }

    public com.vieecoles.entities.zone getZone() {
        return zone;
    }

    public void setZone(com.vieecoles.entities.zone zone) {
        this.zone = zone;
    }
}
